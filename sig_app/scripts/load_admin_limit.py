...
departementt_shp = Path(__file__).resolve().parent.joinpath("data", "Limites_departements.shp")    
commune_shp = Path(__file__).resolve().parent.joinpath("data", "Limites_communes.shp")

#  https://docs.djangoproject.com/fr/6.0/ref/contrib/gis/layermapping/
...
def run(verbose=True):
    ...
    lm_dpt = LayerMapping(Departement, departementt_shp, dpt_mapping, transform=True)
